            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-bold">SEALDAH</p>
                  <p className="text-sm">सियालदह</p>
                </div>
                <div>
                  <p className="text-sm opacity-80">TO</p>
                  <p className="font-bold">DAKSHINESWAR</p>
                  <p className="text-sm">दक्षिणेश्वर</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-bold">ADULT: 2 CHILD: 1</p>
                </div>
                <div>
                  <p className="text-sm opacity-80">CLASS</p>
                  <p className="font-bold">SECOND (II)</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-bold">ORDINARY (O)</p>
                </div>
                <div>
